...
from internal.shared import retrieve_object, pagination
from schemas.core import Model

ModelType = TypeVar("ModelType", bound=Base)
CreateSchemaType = TypeVar("CreateSchemaType", bound=Model)
UpdateSchemaType = TypeVar("UpdateSchemaType", bound=Model)
Id = Union[str, int]
...
class CRUDBase(Generic[ModelType, CreateSchemaType, UpdateSchemaType]):
    ...
    def create(
        ...
        db_obj: ModelType = self.model(**data, **values)
...
class CRUDPaginated(CRUDBase):
    ...
    def get_multi(
            ...
            with_count: bool = True, with_deleted: bool = False,
            query: Optional[Query] = None
